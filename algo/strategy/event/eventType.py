...
"""
All the constants used should be listed here.

"""


EVENT_TIMER = 'eTimer'                  	 #Timer Event
...
EVENT_PROFITCHANGED = 'eProfitChanged'    #Profit Event
EVENT_CASHCHANGED = 'eCashChanged'        #Cash Event
